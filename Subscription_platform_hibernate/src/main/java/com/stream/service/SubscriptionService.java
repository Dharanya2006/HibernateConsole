...
public class SubscriptionService {
    ...
    public boolean activateSubscription(String userID, String planCode, Date startDate, Date endDate, String paymentMethod)
        ...
        if (active != null && active.getPlanCode() != null
                && active.getPlanCode().equalsIgnoreCase(planCode)) {
    ...
    public boolean processPayment(int paymentID, double amount, String paymentMethod) throws ValidationException {
        return processPayment(amount, paymentMethod);
    }

    public boolean processPayment(double amount, String paymentMethod) throws ValidationException {
